<!--
  ...
  Changelog:
    2026-07-25 — Created. Audit of commit 6d5a54f (branch feature/1-1-1-gradle-skeleton).
...
**Audit date:** 2026-07-25 · **Commit audited:** `6d5a54f` · **Branch:** `feature/1-1-1-gradle-skeleton`
...
- [`docs/memory.md`](../memory.md) — the file whose stated purpose is telling any session where the
  ...
  *"In progress: nothing"*. Commit `6d5a54f` landed 19 modules. The one document designed to
...
*Audit method: direct inspection of every cited file at commit `6d5a54f`. Claims about
