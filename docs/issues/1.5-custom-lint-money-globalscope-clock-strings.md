# [1.5] Custom lint (Money/GlobalScope/Clock/strings)
...
**SRS sections:** MNY-001, TIM-001, ARC-006; §21.6  
**Design spec section:** §7 Money & Time, §10 Testing  
...
Progress and phase checklist: [1.5-custom-lint-money-globalscope-clock-strings-tracker.md](1.5-custom-lint-money-globalscope-clock-strings-tracker.md)
...
- [ ] Dependencies (1.1, 1.2, 1.3) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (MNY-001, TIM-001, ARC-006; §21.6) and quote the requirement IDs back
- [ ] Read the design spec section: **§7 Money & Time, §10 Testing**
...
1. Lint rules are errors in CI; no new warnings may merge (§21.6).
...
Full timestamped log: [1.5-custom-lint-money-globalscope-clock-strings-tracker.md](1.5-custom-lint-money-globalscope-clock-strings-tracker.md#verification-log).
...
Atomic task breakdown: [`1.1.5-custom-lint-rules.md`](../features/1.1-project-skeleton/tasks/1.1.5-custom-lint-rules.md).
