# Issue 11.3 — Consents dashboard + one-tap revoke Tracker

**Parent issue:** [11.3-consents-dashboard-one-tap-revoke.md](11.3-consents-dashboard-one-tap-revoke.md)  
**Strategy:** A consents dashboard listing every per-feature consent with grant time and one-tap revoke - the user's control surface over all optional data flows.  
**Branch (integration):** `dev`  
**Branch (implementation):** `feature/11-3-consents-dashboard-one-tap-revoke` → merged to `dev`
...
|---|-------|--------|--------------|
| 1 | Dependencies clear or waived | [ ] | deps: 1.9 |
