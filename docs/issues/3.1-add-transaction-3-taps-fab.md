...
**SRS sections:** §5.3, §18; FR-TXN-004  
...
- [ ] Read the SRS sections cited above (§5.3, §18; FR-TXN-004) and quote the requirement IDs back
...
1. ≤ 3 taps is a hard requirement (FR-TXN-004); amounts are `Money` (MNY-001).
