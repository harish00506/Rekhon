# [12.2] AI evaluation datasets (categorisation/OCR/forecast)
...
**SRS sections:** §21.5; cat ≥ 92% / receipts ≥ 95% / forecast backtests  
...
Progress and phase checklist: [12.2-ai-evaluation-datasets-categorisation-ocr-forecast-tracker.md](12.2-ai-evaluation-datasets-categorisation-ocr-forecast-tracker.md)
...
- [ ] Regressions block merges in CI (§21.5).
...
- [ ] Dependencies (4.2, 3.8, 9.2) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (§21.5; cat ≥ 92% / receipts ≥ 95% / forecast backtests) and quote the requirement IDs back
...
1. Frozen datasets; regression thresholds gate merges (§21.5).
...
Full timestamped log: [12.2-ai-evaluation-datasets-categorisation-ocr-forecast-tracker.md](12.2-ai-evaluation-datasets-categorisation-ocr-forecast-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/12.2-ai-evaluation-datasets-categorisation-ocr-forecast/tasks/` when this issue is too
