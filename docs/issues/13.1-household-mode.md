...
**SRS sections:** §27, §33  
**Design spec section:** §12 Greenfield note, §14 Out of Scope  
...
Progress and phase checklist: [13.1-household-mode-tracker.md](13.1-household-mode-tracker.md)
...
- [ ] Read the design spec section: **§12 Greenfield note, §14 Out of Scope**
...
1. Per-profile isolation from day one (P-01); feature-flagged.
...
Full timestamped log: [13.1-household-mode-tracker.md](13.1-household-mode-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/13.1-household-mode/tasks/` when this issue is too
