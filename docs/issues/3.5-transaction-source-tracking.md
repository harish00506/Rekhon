...
**SRS sections:** §5.3, §18; AI-ARC-003  
...
- [ ] Read the SRS sections cited above (§5.3, §18; AI-ARC-003) and quote the requirement IDs back
...
1. Provenance on every record (AI-ARC-003); show the source (P-02).
