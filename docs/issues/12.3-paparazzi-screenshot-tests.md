# [12.3] Paparazzi screenshot tests
...
Progress and phase checklist: [12.3-paparazzi-screenshot-tests-tracker.md](12.3-paparazzi-screenshot-tests-tracker.md)
...
- [ ] Dependencies (1.8) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (§21.5) and quote the requirement IDs back
...
1. DS components have screenshot tests; diffs gate merges (§21.5).
...
Full timestamped log: [12.3-paparazzi-screenshot-tests-tracker.md](12.3-paparazzi-screenshot-tests-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/12.3-paparazzi-screenshot-tests/tasks/` when this issue is too
