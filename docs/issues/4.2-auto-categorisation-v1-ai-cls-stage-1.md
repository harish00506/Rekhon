...
- [ ] AI-eval dataset: categorisation accuracy ≥ 92%, regression-gated (§21.5).
...
Full timestamped log: [4.2-auto-categorisation-v1-ai-cls-stage-1-tracker.md](4.2-auto-categorisation-v1-ai-cls-stage-1-tracker.md#verification-log).
