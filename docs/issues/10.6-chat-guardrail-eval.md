...
Progress and phase checklist: [10.6-chat-guardrail-eval-tracker.md](10.6-chat-guardrail-eval-tracker.md)
...
- [ ] The regression threshold blocks merges (§21.5); adversarial cases are included.
- [ ] It runs in CI.
...
- [ ] Dependencies (10.5, 9.7) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (§21.5; AI-ARC-004) and quote the requirement IDs back
...
1. The guardrail eval gates merges (§21.5).
...
Full timestamped log: [10.6-chat-guardrail-eval-tracker.md](10.6-chat-guardrail-eval-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/10.6-chat-guardrail-eval/tasks/` when this issue is too
