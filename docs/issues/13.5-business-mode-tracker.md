# Issue 13.5 — Business mode Tracker

**Parent issue:** [13.5-business-mode.md](13.5-business-mode.md)  
**Strategy:** Design-for a lightweight business/freelancer mode (separate books, GST-aware categories) built on the same engines.  
**Branch (integration):** `dev`  
**Branch (implementation):** `feature/13-5-business-mode` → merged to `dev`
