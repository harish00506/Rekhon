# Issue 11.6 — Dependency scan (OSV) + minified release Tracker

**Parent issue:** [11.6-dependency-scan-osv-minified-release.md](11.6-dependency-scan-osv-minified-release.md)  
**Strategy:** CI dependency scanning (OSV) and a minified/shrunk (R8) release build with resource shrinking and log stripping - supply-chain and release hardening.  
**Branch (integration):** `dev`  
**Branch (implementation):** `feature/11-6-dependency-scan-osv-minified-release` → merged to `dev`
