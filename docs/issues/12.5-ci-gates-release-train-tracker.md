# Issue 12.5 — CI gates + release train Tracker

**Parent issue:** [12.5-ci-gates-release-train.md](12.5-ci-gates-release-train.md)  
**Strategy:** The full CI gate set (build, unit+coverage, lint/detekt, screenshot, E2E, dep scan) and the SemVer release train wired to VERSION/CHANGELOG.  
**Branch (integration):** `dev`  
**Branch (implementation):** `feature/12-5-ci-gates-release-train` → merged to `dev`
...
|---|-------|--------|--------------|
| 1 | Dependencies clear or waived | [ ] | deps: 1.1, 12.1 |
