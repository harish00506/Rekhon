...
**Strategy:** The goals engine: target amount + date → required monthly contribution and projected completion, deterministic and evidence-backed.  
**Branch (integration):** `dev`  
**Branch (implementation):** `feature/7-1-goals-engine-ai-goal` → merged to `dev`
...
|---|-------|--------|--------------|
| 1 | Dependencies clear or waived | [ ] | deps: 3.1, 5.1 |
