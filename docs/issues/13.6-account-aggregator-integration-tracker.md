# Issue 13.6 — Account Aggregator integration Tracker

**Parent issue:** [13.6-account-aggregator-integration.md](13.6-account-aggregator-integration.md)  
**Strategy:** Design-for India's Account Aggregator consented data ingestion through the backend - strictly consent-gated, staleness-labelled, and offline-degradable.  
**Branch (integration):** `dev`  
**Branch (implementation):** `feature/13-6-account-aggregator-integration` → merged to `dev`
