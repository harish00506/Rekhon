# Issue 12.1 — Engine golden-file + property test harness Tracker

**Parent issue:** [12.1-engine-golden-file-property-test-harness.md](12.1-engine-golden-file-property-test-harness.md)  
**Strategy:** A shared harness for engine testing: golden-file snapshots (fixed input JSON → expected result JSON), property tests, and seeded-determinism helpers.  
**Branch (integration):** `dev`  
**Branch (implementation):** `feature/12-1-engine-golden-file-property-test-harness` → merged to `dev`
...
|---|-------|--------|--------------|
| 1 | Dependencies clear or waived | [ ] | deps: 1.4 |
