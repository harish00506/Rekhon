# [1.9] Proto DataStore settings & consents
...
**SRS sections:** §23 (consent), §5.9; P-01  
...
Progress and phase checklist: [1.9-proto-datastore-settings-consents-tracker.md](1.9-proto-datastore-settings-consents-tracker.md)

---

## Acceptance Criteria

- [ ] Settings + consent are stored in Proto DataStore (SharedPreferences banned, §21.3).
...
- [ ] Read the SRS sections cited above (§23 (consent), §5.9; P-01) and quote the requirement IDs back
...
1. No off-device data flow without an explicit, revocable consent row (P-01).
...
Full timestamped log: [1.9-proto-datastore-settings-consents-tracker.md](1.9-proto-datastore-settings-consents-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/1.9-proto-datastore-settings-consents/tasks/` when this issue is too
