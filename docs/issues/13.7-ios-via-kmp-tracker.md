# Issue 13.7 — iOS via KMP Tracker

**Parent issue:** [13.7-ios-via-kmp.md](13.7-ios-via-kmp.md)  
**Strategy:** Design-for sharing the pure-Kotlin domain/engine layer to iOS via Kotlin Multiplatform - validated by keeping engines Android-free (ARC-002).  
**Branch (integration):** `dev`  
**Branch (implementation):** `feature/13-7-ios-via-kmp` → merged to `dev`
