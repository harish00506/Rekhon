# [11.4] Erase-all (crypto-shredding)
...
Progress and phase checklist: [11.4-erase-all-crypto-shredding-tracker.md](11.4-erase-all-crypto-shredding-tracker.md)
...
- [ ] Dependencies (1.6, 11.1) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (§23, §34; SEC-003) and quote the requirement IDs back
...
1. Crypto-shred by key destruction; irreversible and confirmed (P-01/SEC-003).
...
Full timestamped log: [11.4-erase-all-crypto-shredding-tracker.md](11.4-erase-all-crypto-shredding-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/11.4-erase-all-crypto-shredding/tasks/` when this issue is too
