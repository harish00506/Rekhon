...
- [ ] Dependencies (8.1) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (§23.3, §34.4) and quote the requirement IDs back
...
Full timestamped log: [8.2-restore-on-fresh-device-tracker.md](8.2-restore-on-fresh-device-tracker.md#verification-log).
