...
- [ ] CRUD for every account type in §11; soft-delete (`deleted_at`) and per-profile scoping.
...
- [ ] Read the SRS sections cited above (§5.7, §11; FR-ACC-*) and quote the requirement IDs back
