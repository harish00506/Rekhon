# [11.3] Consents dashboard + one-tap revoke
...
**Branch:** `feature/11-3-consents-dashboard-one-tap-revoke`

## Tracker

Progress and phase checklist: [11.3-consents-dashboard-one-tap-revoke-tracker.md](11.3-consents-dashboard-one-tap-revoke-tracker.md)
...
- [ ] Dependencies (1.9) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (§23; DPDP, P-01) and quote the requirement IDs back
...
1. Consent is explicit, per-feature, and revocable (P-01).

### Label-specific

1. No off-device data flow without explicit, revocable, per-feature consent (P-01).
2. Purpose-limited, consent-based, rights-respecting data handling (DPDP 2023 / P-01).
...
Full timestamped log: [11.3-consents-dashboard-one-tap-revoke-tracker.md](11.3-consents-dashboard-one-tap-revoke-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/11.3-consents-dashboard-one-tap-revoke/tasks/` when this issue is too
