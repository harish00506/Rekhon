...
- [ ] Dependencies (8.2) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (§21.5, §34.4) and quote the requirement IDs back
...
Full timestamped log: [8.3-backup-restore-drill-tracker.md](8.3-backup-restore-drill-tracker.md#verification-log).
