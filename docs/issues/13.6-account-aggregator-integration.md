# [13.6] Account Aggregator integration
...
**SRS sections:** §16, §22; AA framework  
...
**Branch:** `feature/13-6-account-aggregator-integration`

## Tracker

Progress and phase checklist: [13.6-account-aggregator-integration-tracker.md](13.6-account-aggregator-integration-tracker.md)
...
- [ ] Read the SRS sections cited above (§16, §22; AA framework) and quote the requirement IDs back
...
1. Consent-gated, provenance-tagged, offline-degradable (P-01/P-04).
...
Full timestamped log: [13.6-account-aggregator-integration-tracker.md](13.6-account-aggregator-integration-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/13.6-account-aggregator-integration/tasks/` when this issue is too
