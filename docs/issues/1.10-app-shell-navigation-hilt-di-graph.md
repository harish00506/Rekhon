# [1.10] App shell + navigation + Hilt DI graph
...
**SRS sections:** ARC-001, ARC-003, ARC-004; §21.2  
...
**Branch:** `feature/1-10-app-shell-navigation-hilt-di-graph`

## Tracker

Progress and phase checklist: [1.10-app-shell-navigation-hilt-di-graph-tracker.md](1.10-app-shell-navigation-hilt-di-graph-tracker.md)
...
| `compose-navigation` | One typed nav graph in :app; cross-feature nav via routes only (ARC-001); deep links for widget/notifs. | `~/.claude/skills/compose-navigation/SKILL.md` |
| `hilt-di` | Wire the DI graph: constructor injection, engine @Binds, injected Clock/dispatchers (ARC-003). | `~/.claude/skills/hilt-di/SKILL.md` |
...
- [ ] Dependencies (1.4, 1.8) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (ARC-001, ARC-003, ARC-004; §21.2) and quote the requirement IDs back
...
1. Cross-feature navigation uses typed routes only; feature modules stay independent (ARC-001).
2. Constructor injection via Hilt; no service locators (ARC-003).
...
Full timestamped log: [1.10-app-shell-navigation-hilt-di-graph-tracker.md](1.10-app-shell-navigation-hilt-di-graph-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/1.10-app-shell-navigation-hilt-di-graph/tasks/` when this issue is too
