# [11.1] SQLCipher key management (StrongBox)
...
Progress and phase checklist: [11.1-sqlcipher-key-management-strongbox-tracker.md](11.1-sqlcipher-key-management-strongbox-tracker.md)
...
- [ ] Read the SRS sections cited above (§23; SEC-003) and quote the requirement IDs back
...
1. Keystore/Tink only; the key never leaves the TEE (SEC-003).
...
Full timestamped log: [11.1-sqlcipher-key-management-strongbox-tracker.md](11.1-sqlcipher-key-management-strongbox-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/11.1-sqlcipher-key-management-strongbox/tasks/` when this issue is too
