# [2.6] Net worth = assets - liabilities + daily snapshot
...
**SRS sections:** §5.7 (FR-ACC-005), §20.3 (DB-001)  
...
Progress and phase checklist: [2.6-net-worth-assets-liabilities-daily-snapshot-tracker.md](2.6-net-worth-assets-liabilities-daily-snapshot-tracker.md)
...
- [ ] Read the SRS sections cited above (§5.7 (FR-ACC-005), §20.3 (DB-001)) and quote the requirement IDs back
...
1. Numbers from math (P-03); the snapshot uses the injected `Clock` (TIM-001).
...
Full timestamped log: [2.6-net-worth-assets-liabilities-daily-snapshot-tracker.md](2.6-net-worth-assets-liabilities-daily-snapshot-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/2.6-net-worth-assets-liabilities-daily-snapshot/tasks/` when this issue is too
