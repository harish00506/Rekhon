...
Progress and phase checklist: [13.2-appliances-maintenance-tracker.md](13.2-appliances-maintenance-tracker.md)
...
- [ ] Dependencies (10.4) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (§38) and quote the requirement IDs back
...
1. KB-driven, explainable, flagged (§29/P-02).
...
Full timestamped log: [13.2-appliances-maintenance-tracker.md](13.2-appliances-maintenance-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/13.2-appliances-maintenance/tasks/` when this issue is too
