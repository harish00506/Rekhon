# [11.7] No-hand-rolled-crypto (Tink) audit
...
Progress and phase checklist: [11.7-no-hand-rolled-crypto-tink-audit-tracker.md](11.7-no-hand-rolled-crypto-tink-audit-tracker.md)
...
- [ ] Dependencies (1.6, 8.1) are complete or explicitly waived by the user
- [ ] Read `docs/issues/00-issue-workflow.md` and `CLAUDE.md`
- [ ] Read the SRS sections cited above (SEC-003) and quote the requirement IDs back
...
1. No hand-rolled crypto anywhere (SEC-003, review-blocking).
...
Full timestamped log: [11.7-no-hand-rolled-crypto-tink-audit-tracker.md](11.7-no-hand-rolled-crypto-tink-audit-tracker.md#verification-log).
...
No sub-tasks yet. Break into `docs/features/11.7-no-hand-rolled-crypto-tink-audit/tasks/` when this issue is too
